...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private void configureAutoBuilder() {
        try {
            ...
            new ModuleConfig(Inches.of(Constants.Drivetrain.DRIVETRAIN_WHEEL_DIAMETER), TunerConstants.kSpeedAt12Volts, 0.7, DCMotor.getKrakenX60(1).withReduction(Constants.Drivetrain.DERIVETRAIN_GEAR_RATIO), Amps.of(20), 1), getModuleLocations());
